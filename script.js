...
window.addEventListener("load", function() {
   ...
   listedPlanetsResponse.then(function (result) {
       ...
       addDestinationInfo(document, selectedPlanet.name, selectedPlanet.diameter, selectedPlanet.star, selectedPlanet.distance, selectedPlanet.image, selectedPlanet.moons);
    })
